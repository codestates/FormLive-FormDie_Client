...
export default function LoginForm({ loginClick, setLoginClick }) {
	interface login {
		email: string;
		password: string;
	}
				...
				<form>
					...
					<section className={styles.section}>
						...
						<div className={styles.section__input__border}>
							<input
								className={styles.section__input__border__inputEmail}
								type="email"
								name="email"
								placeholder="Email Address"
						...
						<div className={styles.section__input__border}>
							<input
								className={styles.section__input__border__inputPW}
								type="password"
								name="password"
								placeholder="Password"
