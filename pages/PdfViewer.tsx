  ...
  <Document>
    <Page style={styles.body}>
      ...
      <Text style={styles.subtitle}>
        awefawefasdfasdafsdfawsdefw
      </Text>
      <Text style={styles.text}>
        En un lugar de la Mancha, de cuyo nombre no quiero acordarme, no ha
        muchosadfsadfadsfasdfasdfsdafasdfasdfsdf
      </Text>
      <Text style={styles.text}>
...
Font.register({
  family: 'Oswald',
  //src: '../public/font/YoonGothic750.ttf'
...
const PdfViewer = ({url, width, pageNumber, anything}) => {
...
PdfViewer.getInitialProps = async (context) => {
